...
?>
<div class="mod-sellacious-sellerproducts sellerproducts-grid-layout <?php echo $class_sfx; ?>">
	<?php foreach ($products AS $product):
		...
		$sl_params = array(
			'title'    => JText::_('MOD_SELLACIOUS_SELLERPRODUCTS_QUICK_VIEW'),
			'url'      => $url_m,
			'height'   => '600',
			'width'    => '800',
			'keyboard' => true,
		...
		<div class="sellerproducts-wrap-grid">
						...
						<div class="product-action-btn">
							...
							<?php if ($displayquickviewbtn == '1'): ?>
								<a href="#modal-<?php echo $code; ?>" role="button" data-toggle="modal" class="btn btn-default btn-quick-view">
									<i class="fa fa-search"></i> <?php echo JText::_('MOD_SELLACIOUS_SELLERPRODUCTS_QUICK_VIEW'); ?>
								</a>
							<?php endif; ?>
						</div>
					<?php endif; ?>
