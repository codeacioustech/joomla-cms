...
JHtml::_('stylesheet', JUri::root() . 'modules/mod_sellacious_relatedproducts/assets/css/owl.carousel.min.css');
...
JHtml::_('script', 'com_sellacious/fe.view.sellacious', false, true);
...
?>
<div class="mod-sellacious-relatedproducts related-carousel-layout <?php echo $class_sfx; ?>">
	<div class="related-productcarousel owl-carousel" id="related-productcarousel<?php echo $module->id; ?>">
...
<script type="text/javascript">
	jQuery(document).ready(function ($) {
		...
		var owl = $('#related-productcarousel<?php echo $module->id ?>');
		owl.owlCarousel({
			nav: true,
			navText: [
...
<?php
JHtml::_('script', JUri::root() . 'modules/mod_sellacious_relatedproducts/assets/js/owl.carousel.js');
?>
