...
?>
<div class="mod-sellacious-bestsellingproducts bestsellingproducts-list-layout <?php echo $class_sfx; ?>">
	<?php foreach ($products AS $product):
		...
		<div class="bsp-product-wrap-list">
			<div class="bsp-product-box" data-rollover="container">
				<div class="image-box">
					<a href="<?php echo $url; ?>">
				...
				<div class="bsp-product-info-box">
					...
					if ($seller_attr->price_display == 0)
					{
						...
						{
							$price = round($item->price_id, 3) > 0 ? $helper->currency->display($item->sales_price, $s_currency, $c_currency, true) : JText::_('MOD_SELLACIOUS_BESTSELLINGPRODUCTS_NOT_AVAILABLE');
								...
								<?php if ((int) $seller_attr->stock_capacity > 0): ?>
									...
									<?php if ($displaybuynowbtn == '1'): ?>
										<button type="button" class="btn btn-default btn-add-cart buy" data-item="<?php echo $code; ?>" data-checkout="true">
											<i class="fa fa-bolt" aria-hidden="true"></i> <?php echo JText::_('MOD_SELLACIOUS_BESTSELLINGPRODUCTS_BUY_NOW'); ?>
										</button>
									<?php endif; ?>
								<?php else: ?>
									<hr class="isolate">
