...
<head>
	...
	<?php if ($app->get('debug_lang', '0') == '1' || $app->get('debug', '0') == '1') : ?>
		...
		<link href="<?php echo JHtml::_('stylesheet', 'cms/debug.css', array('relative' => true, 'pathOnly' => true)); ?>" rel="stylesheet" />
	<?php endif; ?>
	<?php // If Right-to-Left ?>
	<?php if ($this->direction == 'rtl') : ?>
		<link href="<?php echo JHtml::_('stylesheet', 'jui/bootstrap-rtl.css', array('relative' => true, 'pathOnly' => true)); ?>" rel="stylesheet" />
	<?php endif; ?>
	...
	<script src="<?php echo JHtml::_('script', 'jui/jquery.js', array('relative' => true, 'pathOnly' => true)); ?>"></script>
	<script src="<?php echo JHtml::_('script', 'jui/jquery-noconflict.js', array('relative' => true, 'pathOnly' => true)); ?>"></script>
	<script src="<?php echo JHtml::_('script', 'jui/bootstrap.js', array('relative' => true, 'pathOnly' => true)); ?>"></script>
