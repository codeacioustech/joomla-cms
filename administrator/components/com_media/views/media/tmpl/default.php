...
echo JHtml::_(
	...
	'<div id="image" style="text-align:center;"><img id="imagePreviewSrc" src="' . JHtml::_('image', 'jui/alpha.png', null, null, true, 1) . '" alt="preview" style="max-width:100%; max-height:300px;"/></div>'
);
