...
class SellaciousViewCategories extends SellaciousView
{
	...
	protected function getCurrent()
	{
		...
		$this->helper->category->getTranslatedCategory($item);
		...
		//	$this->app->redirect(JRoute::_('index.php?option=com_sellacious&view=products&category_id=' . $item->id . $suffixStore . $suffixManufacturer));
		}
