...
class SellaciousModelCategory extends SellaciousModelAdmin
{
	...
	public function save($data)
	{
		...
		$this->saveTranslations($translations, $table->get('id'));
	...
	protected function preprocessData($context, &$data, $group = 'content')
	{
		...
		if (is_object($data))
		{
			...
			if ($data->id)
			{
				$data->translations = $this->helper->category->getCategoryTranslations($data->id);
			}
	 ...
	 * @since   1.6.0
	 */
	public function saveTranslations($data, $id)
	{
		if (empty($data))
		{
			return true;
