...
{
	$canDelete  = $this->helper->access->check('transaction.delete', $item->id) ||
		($this->helper->access->check('transaction.delete.own') && $item->context_id == $me->id);
	?>
	<tr role="row">
		...
		<td class="text-center" style="width:100px;">
			<?php echo $this->escape($item->txn_number); ?>
		</td>
		<td class="text-center" style="width:100px;">
