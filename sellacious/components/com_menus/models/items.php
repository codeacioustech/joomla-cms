...
class MenusModelItems extends JModelList
{
	...
	protected function populateState($ordering = 'a.lft', $direction = 'asc')
	{
		...
		// Client id filter
		$clientId = (int) $this->getUserStateFromRequest($this->context . '.client_id', 'client_id', 2, 'int');
		...
		// IMPORTANT: Remove this when starting support for all menuTypes and client_ids
		if ($this->state->get('client_id') != 2)
		{
			$this->state->set('client_id', 2);
			$this->state->set('menutype', 'sellacious-menu');
		}
	}
