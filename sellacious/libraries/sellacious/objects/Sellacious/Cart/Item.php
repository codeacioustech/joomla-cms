...
abstract class Item
{
	...
	public function setQuantity($quantity)
	{
		...
		if (($minQ && $quantity < $minQ) || ($maxQ && $quantity > $maxQ))
		{
			if ($minQ == $maxQ)
			{
				throw new \Exception(\JText::sprintf('COM_SELLACIOUS_CART_ITEM_ORDER_QUANTITY_MISMATCH', $minQ));
			}
			else
			{
				throw new \Exception(\JText::sprintf('COM_SELLACIOUS_CART_ITEM_ORDER_QUANTITY_RANGE_MISMATCH', $minQ, $maxQ));
			}
		}
