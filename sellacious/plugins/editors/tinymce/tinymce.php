...
class PlgEditorTinymce extends JPlugin
{
		...
		$name, $content, $width, $height, $col, $row, $buttons = true, $id = null, $asset = null, $author = null, $params = array())
	{
		...
		{
			$externalPlugins['jdragdrop'] = JHtml::_('script', 'media/editors/tinymce/js/plugins/dragdrop/plugin.min.js', array('relative' => false));
			$allowImgPaste = true;
			$isSubDir      = '';
		...
		$name, $content, $width, $height, $col, $row, $buttons = true, $id = null, $asset = null, $author = null, $params = array())
	{
		...
		if ($dragdrop && $user->authorise('core.create', 'com_media'))
		{
			...
			$externalPlugins = array(
				array('jdragdrop' => JHtml::_('script', 'media/editors/tinymce/js/plugins/dragdrop/plugin.min.js', array('relative' => false))),
			);
		}
